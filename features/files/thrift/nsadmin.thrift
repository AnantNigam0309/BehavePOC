...
struct OrgCreditDetails {
  ...
  6:optional i64 lastUpdatedBy;
  7:optional i64 lastUpdatedAtTimestamp;
}
...
enum DeliveryStatus { DELIVERED, NOT_DELIVERED, HARD_BOUNCED, SOFT_BOUNCED, OPENED, CLICKED, MARKED_SPAM, IN_GTW, GTW_PROCESSED}

enum MessageClass { SMS, EMAIL, WECHAT, ANDROID, IOS }
...
struct OrgStatusDetails {
  ...
  2:bool active
  3:i64 updatedBy
  4:i64 updatedAtTimestamp
  5:optional EnumBoolean customSenderAdded = EnumBoolean.DEFLT
}
...
service NSAdminService {
	...
	DomainPropertiesGatewayMap validateDomain(1:i64 domainPropGatewayMapId, 2:i64 triggeredBy)
...
//  bool addDomainGatewayMapForMobilePush(1:i64 orgId, 2:MessageClass channelType, 3:string priority, 4:string
//  licenseCode, 5:string authToken, 6:string campaignId, 7:string variationId) throws (1:NSAdminException ex)
}
